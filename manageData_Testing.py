    ...
    ##### Opens files and splits to get timestamp #####
        ...
        for i, value in enumerate(time_list2): 
            if value > time_list2[i-1]+3:
                ...
                filename1 = "%2d%02d%02d_SCAN_%s_%s.dat" % (tm_obj.tm_year-2000, tm_obj.tm_mon, tm_obj.tm_mday,scount, location)
